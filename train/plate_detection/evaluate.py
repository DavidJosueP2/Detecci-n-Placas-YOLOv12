...
OUTPUTS_DIR = PROJECT_ROOT / "outputs_yolo11_license_plate"
RESULTADOS_DIR = PROJECT_ROOT / "resultados_evaluacion"
...
DATASETS = {
    "License Plate Recognition": {
        "yaml": ROOT / "configs" / "license_plate_recognition.yaml",
        "short": "lpr",
    },
    "Placas Ecuador": {
        "yaml": ROOT / "configs" / "placas_ecuador_preparado.yaml",
        "short": "ecuador",
    },
}
...
def descubrir_modelos() -> dict[str, Path]:
    ...
    # 4. yolo12s.pt en la raíz del proyecto (base preentrenado)
    base_pt = PROJECT_ROOT / "yolo12s.pt"
    if base_pt.exists():
