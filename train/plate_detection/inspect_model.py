...
ruta = PROJECT_ROOT / "models" / "Best_epoch_1_90mil.pt"
# ruta = PROJECT_ROOT / "modelos" / "placas_yolo12_pro" / "weights" / "last.pt"
# ruta = PROJECT_ROOT / "models" / "best_placas_ecuador.pt"

salida_txt = PROJECT_ROOT / "reporte" / "reporte_completo_pt.txt"
salida_json = PROJECT_ROOT / "reporte" / "reporte_resumen_pt.json"
